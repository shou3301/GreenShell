 ...
 * 
 */
public class EPlusExecFactory extends ExecutorFactory {

	private GreenShInfo greenShInfo = null;
	private UserOption uo = null;
	private CsvResult csvResult = null;

	public EPlusExecFactory(GreenShInfo greenShInfo, UserOption uo, CsvResult csvResult) {
	...
	private void addJobs() {
		...
		Executor idf = new IdfGenerator("..", idfTarget, templatePool, uo.getChoosenTemplate());
